...
export const EventTicket = ({id,foto,precio,tipo,eventoNombre,eventoFecha,eventoHora}) => {
  const fechaHoraCompleta = `${eventoFecha} - ${eventoHora}`;
  const {dia,mes,hora: horaVisual, } = formatearFechaParaCard(fechaHoraCompleta);
