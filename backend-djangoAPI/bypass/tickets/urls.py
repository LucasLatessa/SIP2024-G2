...
urlpatterns = [
    ...
    path('Publicacion/publicas', views.get_all_publication, name='get_all_publication'),
    ...
    path('Ticket/preferencia_transferir', views.preferenciaTransferir, name='preferenciaTransferir'),
